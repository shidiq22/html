...
jQuery(document).ready(function($){
	...
	{
		//google map
		var coordinate = new google.maps.LatLng(-6.241783, 106.836029);
		var mapOptions = {
			zoom: 15,
			center: coordinate,
		...
		marker = new google.maps.Marker({
			...
			map: map,
			icon: new google.maps.MarkerImage("po-content/newchingsy/images/icons/other/map_pointer.png", new google.maps.Size(38, 45), null, new google.maps.Point(18, 44))
		});
	}
