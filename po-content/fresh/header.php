...
<head>
    ...
    <meta http-equiv="Copyright" content="RS Paru Dr. H. A. Rotinsulu" />
    <meta name="author" content="Nurshidiq Pratama Priatna" />
			...
			<div class="col-md-12">
				<header class="site-header">
					<section class="site-logo">
						<a href="<?=$website_url;?>"><img src="<?=$website_url;?>/po-content/<?=$folder;?>/assets/images/logo@2x.png" width="350" /></a>
					</section>
					<nav class="site-nav">
						...
						<div class="col-sm-6">
							<ul class="social-networks text-right">
								...
								<li><a href="http://twitter.com/rsprotinsulu"><i class="entypo-twitter"></i></a></li>
								<li><a href="http://www.facebook.com/rsprotinsulu"><i class="entypo-facebook"></i></a></li>
							</ul>
						</div>
					</nav>
				</header>
